RSpec.describe Admin::Views::Users::Index, type: :view do
  ...
  let(:exposures) { Hash[format: :html, users: users, params: {}, flash: {}, current_user: double_user] }
  let(:template)  { Hanami::View::Template.new('apps/admin/templates/users/index.html.erb') }
